  ...
  return (
    <section className="w-full px-4 py-10 sm:px-8 lg:px-12">
      <div className="mx-auto w-full max-w-6xl">
        <div className="mt-4 grid divide-y divide-[#ED2738]/20 overflow-hidden rounded-2xl border border-[#ED2738]/20 md:grid-cols-3 md:divide-x md:divide-y-0">
          {trustItems.map((item) => (
            <article key={item.label} className="bg-[#F7DBE2]/50 px-5 py-4 text-center">
