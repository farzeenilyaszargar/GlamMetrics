...
export default function Trust() {
  return (
    <section className="w-full px-4 py-10 max-sm:py-8 sm:px-8 lg:px-12">
        ...
        <div className="mt-4 grid divide-y divide-[#ED2738]/20 md:grid-cols-3 md:divide-x md:divide-y-0">
          {trustItems.map((item) => (
            <article key={item.label} className="px-5 py-4 text-center">
              <p className="font-emilys-candy text-4xl leading-none text-[#ED2738] max-sm:text-3xl">{item.value}</p>
